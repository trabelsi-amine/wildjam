...
func ChangeName(token:String,name:String):
	return Request.request("https://api.lootlocker.io/game/player/name",["x-session-token: " + token, "LL-Version: 2021-03-01","Content-Type: application/json"],HTTPClient.METHOD_PATCH,"{\"name\": \""+name+"\"}")
